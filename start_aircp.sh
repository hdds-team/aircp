...
case "${1:-help}" in
    ...
    all)
        ...
        ENV_VARS="unset CLAUDECODE CLAUDE_CODE_ENTRYPOINT; HDDS_REUSEPORT=1 HDDS_LIB_PATH=$HDDS_LIB_PATH LD_LIBRARY_PATH=$LD_LIBRARY_PATH PYTHONPATH=$PYTHONPATH MISTRAL_API_KEY=$MISTRAL_API_KEY FORUM_API_URL=$FORUM_API_URL GITHUB_TOKEN=$GITHUB_TOKEN GITHUB_REPOS=$GITHUB_REPOS"
